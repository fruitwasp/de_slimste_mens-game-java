...
import helper.TurnIngelijstItem;
...
public class IngelijstObserview extends TurnBasePanel implements ObserverObserver {
	...
	private ArrayList<TurnIngelijstItem> words;
...
//	private JTextField answer;
	...
	public IngelijstObserview(MainController mainController) {
		super(mainController);
		
		words = new ArrayList<TurnIngelijstItem>();
...
//			public void actionPerformed(ActionEvent arg0) {
//				
//				TurnIngelijstController turnIngelijstController = (TurnIngelijstController) mainController.getTurnIngelijstController();
//				turnIngelijstController.onAttemptSubmitted(answer.getText().toLowerCase());
//				
//			}
//			
//			
//		});
	...
	private void setQuestions(ArrayList<String> questions) {
		...
		for (String question : questions) {
			...
			words.add(new TurnIngelijstItem(question));
		}
		
		for (TurnIngelijstItem turnIngelijstItem : words) {			
			panelWithAnswers.add(turnIngelijstItem);
		}
	}	
